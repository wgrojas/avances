<template>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header"><h4>Crear Historia</h4></div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                              ...
                              <div class="col-12 mb-2">
                                <div class="form-group">
                                    <label>Fecha</label>
                                    <input type="date" class="form-control" v-model="historial.fecha">
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="form-group">
...
export default {
    ...
    methods:{
        async crear(){
            await this.axios.post('api/historial', this.historial).then(response=>{
